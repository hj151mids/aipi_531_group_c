...
We used the source code from Xinxin where they implemented the joint training of supervised learning and SNQN reinforcement learning loss on the replay buffer. We added a dense layer called `output_phi` to the supervised learning model, which mixed the score generated by GRU4Rec and the score generated by feature embeddings. The general structure of the part that we implemented resembles the HRNN model proposed by Ma.  

![image](https://user-images.githubusercontent.com/90075179/236368867-043831f8-6802-4598-9593-e0336186761a.png)
